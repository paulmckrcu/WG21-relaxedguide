...
\begin{document}
\title{D2055R1: A Relaxed Guide to \co{memory_order_relaxed}}

\newcommand{\co}[1]{\lstinline[breaklines=yes,breakatwhitespace=yes]{#1}}

\author{
Hans Boehm\\\email{hboehm@google.com} \and
David Goldblatt\\\email{davidtgoldblatt@gmail.com} \and
...
If the \co{bad_behavior()} functions on lines~8 and~15 invoke undefined
...
call to the \co{bad_behavior()} function in the first place.
...
Use of \co{memory_order_relaxed} can be tricky because we do not yet
have an efficient way to formally define the boundaries of OOTA and
RFUB.
Important \co{memory_order_relaxed} use cases work in practice, but
...
The good news is that many common \co{memory_order_relaxed} use cases
...
``D2055R1: A Relaxed Guide to \co{memory_order_relaxed}''
