...
But in the meantime, \co{memory_order_relaxed} is seeing increased use,
so that there is a need to identify known-safe usage patterns.
...
including the one resulting in the final values of both \co{x} and
\co{y} being \co{1}.
